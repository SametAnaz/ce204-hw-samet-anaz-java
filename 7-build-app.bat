...
rd /S /Q "password-app\target\site\coverxygen"
rd /S /Q "password-app\target\site\coveragereport"
rd /S /Q "password-app\target\site\doxygen"
...
call perl C:\ProgramData\chocolatey\lib\lcov\tools\bin\genhtml --legend --title "Documentation Coverage Report" ./password-app/target/site/coverxygen/lcov.info -o password-app/target/site/coverxygen

echo Copy badge files to the "assets" directory
call copy "password-app\target\site\coveragereport\badge_combined.svg" "assets\badge_combined.svg"
call copy "password-app\target\site\coveragereport\badge_combined.svg" "assets\badge_combined.svg"
call copy "password-app\target\site\coveragereport\badge_branchcoverage.svg" "assets\badge_branchcoverage.svg"
call copy "password-app\target\site\coveragereport\badge_linecoverage.svg" "assets\badge_linecoverage.svg"
call copy "password-app\target\site\coveragereport\badge_methodcoverage.svg" "assets\badge_methodcoverage.svg"

call copy "assets\rteu_logo.jpg" "password-app\src\site\resources\images\rteu_logo.jpg"

echo Copy the "assets" folder and its contents to "maven site images" recursively
call robocopy assets "password-app\src\site\resources\assets" /E

echo Copy the "README.md" file to "password-app\src\site\markdown\readme.md"
call copy README.md "password-app\src\site\markdown\readme.md"
...
call tar -czvf release\test-coverage-report.tar.gz -C password-app\target\site\coveragereport .

echo Package Code Documentation
call tar -czvf release\application-documentation.tar.gz -C password-app\target\site\doxygen .

echo Package Documentation Coverage
call tar -czvf release\doc-coverage-report.tar.gz -C password-app\target\site\coverxygen .

echo Package Product Site
call tar -czvf release\application-site.tar.gz -C password-app\target\site .
